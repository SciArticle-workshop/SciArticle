...
DEFAULT_UPLOAD_FOR_SUBSCRIPTION = os.environ.get('DEFAULT_UPLOAD_FOR_SUBSCRIPTION')
DEFAULT_VALIDATION_FOR_SUBSCRIPTION = os.environ.get('DEFAULT_VALIDATION_FOR_SUBSCRIPTION')
